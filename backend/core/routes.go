...
func registerAllRoutes(r *mux.Router) {
	...
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/eval-reports/detail", []string{"qa.read"}, agent.GetThreadResultEvalReportDetail)
	...
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/abtests/detail", []string{"qa.read"}, agent.GetThreadResultAbtestDetail)
